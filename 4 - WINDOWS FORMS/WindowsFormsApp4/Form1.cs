...
namespace WindowsFormsApp4
{
    ...
    {
        public static List<ProjetoS> testes = new List<ProjetoS>();
        ...
        private void SetupDataGridView()
        {
            ...
            dataGridView1.Columns[5].Name = "Ativo";
        ...
        {
            var novo = new ProjetoS();
            novo.Nome = txtString.Text;
            novo.Ativo = Ativo.Checked;
        ...
        private void AtualizarLista()
        {
            ...
            {
                dataGridView1.Rows.Add(new object[] { "Clique para Alterar", "Clique para Excluir", i.Id.ToString(), i.DataHora.ToString(), i.Nome, i.Ativo.ToString()});
            }
        }
